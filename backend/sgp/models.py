...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    projects = models.ManyToManyField(
        'Project', related_name='users', blank=True)
...
class Task(models.Model):
    ...
    epic = models.ForeignKey(
        'Epic', on_delete=models.SET_NULL, null=True, blank=True, related_name='tasks')
...
class Invite(models.Model):
    project = models.ForeignKey(Project, on_delete=models.CASCADE)
    user_invited = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name='invites_received')
    inviter = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name='invites')
    creation_date = models.DateTimeField(auto_now_add=True)
